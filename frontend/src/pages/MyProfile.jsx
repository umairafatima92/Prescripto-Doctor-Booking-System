...
const MyProfile = () => {
  ...
  return userData && (
    <div className='mx-4 sm:mx-[5vw] md:mx-[7vw] lg:mx-[9vw] max-w-lg flex flex-col gap-2 text-sm pt-5'>

      {
        ...
        <label htmlFor="image">
          <div className='inline-block relative cursor-pointer '>
            ...
            <img className='w-10 absolute bottom-12 right-12 ' src={image ? assets.upload_icon :assets.upload_icon} alt="" />
          </div>
